...
public class MedcareRegistrationCreator 
{
	WebDriver driver;
	...
	@Test(priority=0, description="Click on OutPatientRegistration and Register Patient")
    public void OutPatientRegistration() throws Exception 
    {	
		final MedcareDashboardPage DashBoard = new MedcareDashboardPage(driver);
